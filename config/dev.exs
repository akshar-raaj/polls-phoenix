...
config :polls, PollsWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "vUgqof7oItHt9qICq9U6vuBHC2UN6J7A8c6GPFPlqDUGjb1hKa93z+BviVAJnBp+",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:polls, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:polls, ~w(--watch)]}
  ]
...
config :polls, PollsWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/polls_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
